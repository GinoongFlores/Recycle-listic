...
public class TotalMonthDayYear extends AppCompatActivity {
    Button btnSearchYear,btnBackViewRecords;
    Spinner spinMonth;
    EditText etSearchDay,etSearchYear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_month_day_year);
        ...
        etSearchDay = findViewById(R.id.etSearchDay);
        etSearchYear = findViewById(R.id.etSearchYear);
        city = getIntent().getExtras().getString("toMMDDYY");
        ...
        btnSearchYear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String mmddyy = spinMonth.getSelectedItem().toString()+etSearchDay.getText().toString()+"," + etSearchYear.getText().toString();
                entries = new ArrayList<>();
                Query paperQuery = myRef.child(city).orderByChild("mmddyy").equalTo(mmddyy);
