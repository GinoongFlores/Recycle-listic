...
public class TotalMonthYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_month_year);
        ...
        city = getIntent().getExtras().getString("toMMYY");
        ...
        btnSearchYear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String mmyy = spinMonth.getSelectedItem().toString() + etSearchYear.getText().toString();
                entries = new ArrayList<>();
                Query paperQuery = myRef.child(city).orderByChild("mmyy").equalTo(mmyy);
